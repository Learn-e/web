      ...
      <div className="flex flex-row w-[60%] gap-24 items-center mx-auto">
        <div className="flex flex-col justify-start w-1/2">
          ...
          <p className="mt-3 leading-6 text-justify">
            ...
            Profitez d&apos;un apprentissage sans limites et bâtissez des
            compétences qui sont véritablement globales
          </p>
          <Button
    ...
    <div className="flex flex-row-reverse w-[60%] py-24 gap-24 items-center mx-auto">
      <div className="flex flex-col items-end justify-start w-1/2">
        ...
        <p className="mt-3 leading-6 text-justify" style={{ direction: "rtl" }}>
          ...
          ses propres horaires et engagements. C&apos;est pourquoi nous vous
          offrons la possibilité d&apos;apprendre selon vos termes. Que vous
          soyez un lève-tôt ou un noctambule, nos ressources sont disponibles
          24/7, vous permettant de vous former à des moments qui vous
          conviennent. Notre plateforme s&apos;adapte non seulement à votre
          emploi du temps, mais aussi à votre rythme d&apos;apprentissage, avec
          des cours pouvant être mis en pause et repris à tout moment. Maximisez
          votre potentiel sans compromettre votre style de vie actuel
        </p>
        <Button
          className="mt-3 text-lg font-bold w-fit"
          size={"lg"}
    ...
    <div className="flex flex-row w-[60%] py-24 gap-24 items-center mx-auto">
      <div className="flex flex-col justify-start w-1/2">
        ...
        <p className="mt-3 leading-6 text-justify">
          ...
          les complexités de l&apos;économie asiatique, à maîtriser l&apos;art
          culinaire français, ou à plonger dans la littérature sud-américaine,
          Learn-E rend tout cela accessible en quelques clics. Profitez de un
    ...
    <div className="relative w-full h-full">
      <div className="absolute top-0 left-0 z-10 flex flex-col items-center w-full h-full mx-auto mt-12 text-center">
        ...
        <p className="w-[55%] mt-5 mb-12 text-xl leading-7 text-center">
          ...
          importante que la performance de vos tunnels de vente. C&apos;est
          pourquoi nous vous offrons les outils pour améliorer les deux,
          assurant ainsi une croissance continue de vos ventes.{" "}
        </p>
