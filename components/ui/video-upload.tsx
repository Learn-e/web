  ...
  return (
    <div className="w-full" {...getRootProps()}>
      <motion.div
        onClick={handleClick}
        whileHover="animate"
        className="relative block w-full p-5 overflow-hidden rounded-lg cursor-pointer group/file"
      >
        <input
          ref={fileInputRef}
        ...
        <div className="flex flex-col items-center justify-center">
          ...
          <p className="relative z-20 mt-2 font-sans text-base font-normal text-center text-neutral-400 dark:text-neutral-400">
            Glissez et déposez votre fichier ici ou cliquez pour le télécharger
          </p>
              ...
              >
                {isDragActive ? (
                  <motion.p
                    initial={{ opacity: 0 }}
                    animate={{ opacity: 1 }}
                    className="flex flex-col items-center text-center text-neutral-600"
                  >
                    Lâchez pour télécharger
                    <IconUpload className="w-6 h-6 pt-2 text-neutral-600 dark:text-neutral-400" />
                  </motion.p>
                ) : (
